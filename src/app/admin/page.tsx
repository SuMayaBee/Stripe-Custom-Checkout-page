					...
					<div className="flex items-center justify-between">
						<div className="flex items-center">
							...
							<div className="flex flex-col">
								...
								<p className="text-sm text-gray-500">Manage your payment links</p>
							</div>
						</div>
			...
			<div className="max-w-7xl mx-auto px-4 py-8">
							...
							<div className="space-y-4">
								...
								<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
									<p className="text-sm text-yellow-800">
										<strong>Warning:</strong> Changing credentials will log you out. Make sure to remember your new login details.
									</p>
								</div>
							</div>
				...
				<div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
					<div className="px-8 py-6 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-white/30">
						...
						<p className="text-sm text-gray-500 mt-1">Manage and track your payment links</p>
					</div>
					...
					{paymentLinks.length === 0 ? (
						<div className="p-16 text-center">
							...
							<h3 className="text-xl font-bold text-gray-900 mb-3">No payment links yet</h3>
							<p className="text-gray-500 mb-6 max-w-sm mx-auto">Create your first payment link to start accepting payments from your clients</p>
							<Button
								onClick={() => setShowCreateForm(true)}
										...
										<tr key={link.id} className="hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-purple-50/50 transition-all duration-300 group">
											<td className="px-8 py-6 whitespace-nowrap">
												<div className="flex items-center">
													...
													<div>
														<div className="text-sm font-semibold text-gray-900">{link.clientName}</div>
														<div className="text-sm text-gray-500">{link.clientEmail}</div>
													</div>
												</div>
											</td>
											<td className="px-8 py-6">
												<div className="max-w-xs">
													<div className="text-sm font-semibold text-gray-900 mb-1">{link.service}</div>
													<div className="text-sm text-gray-500 truncate">{link.reason}</div>
												</div>
											</td>
											<td className="px-8 py-6 whitespace-nowrap">
